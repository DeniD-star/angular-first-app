...
Promise.resolve(1000).then(x=> x + 1).then(console.log);//asinhronno

of(1000, 200, 300).pipe(map(x => x + 100)).subscribe((x)=>console.log(x))//obzurvable, moje sinhronno e asinhronno. kakto iskame nie.
